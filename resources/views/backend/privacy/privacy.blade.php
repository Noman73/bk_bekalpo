        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                  <textarea class="form-control" name="" id="description" cols="30" rows="10">{{\App\Models\Privacy::first()->description}}</textarea>
...
@include('backend.privacy.internal-assets.js.script');
