        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <textarea class="form-control" name="" id="description" cols="30" rows="10">{{(\App\Models\TermsAndCondition::first() ? \App\Models\TermsAndCondition::first()->description : "")}}</textarea>
                    <div class="invalid-feeedback" id="description_msg">
...
@include('backend.termscondition.internal-assets.js.script');
