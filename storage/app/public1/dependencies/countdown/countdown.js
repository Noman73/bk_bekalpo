...
function countdown($element, $daysAdd, $hoursAdd, $minutesAdd, $secondsAdd) {
    ...
    var interval = setInterval(function() {
        ...
        // TIMER
        $timerHtmlStart = '<div style="color: ' + $config.timer_color + '; font-weight: ' + $config.timer_font_weight + '; font-family: ' + $config.timer_font + '; font-size: ' + $config.timer_font_size + 'px;">';
        $timerHtmlEnd = '</div>';
